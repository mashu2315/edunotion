  ...
  return (
    <div className="bg-richblack-800">
            ...
            <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
              ...
              <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
                  <Link ro="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                  <img src={Logo} alt="Logo" width={180} loading="lazy" className="object-contain"/>
                  </Link>
                  <h1 className="text-richblack-50 font-semibold text-[16px]">Company</h1>
                  <div className="flex flex-col gap-2">{["About","Careers","Affiliates"].map((element,index)=>{
                    return(
                  ...
                  <div className="flex gap-3 text-lg">
                    <a href="https://github.com/mashu2315
                    " className="cursor-pointer hover:text-richblack-50 transition-all duration-200 "><FaGithub /></a>
                    <a href="https://www.linkedin.com/in/ashutosh-maurya-634bb831a/" className="cursor-pointer hover:text-richblack-50 transition-all duration-200 "><FaLinkedin /></a>
                   <a href="" className="cursor-pointer hover:text-richblack-50 transition-all duration-200 ">  <BsTwitterX /></a>
                    <a  href="mailto:mauryaashutosh1983@gmail.com" className="cursor-pointer hover:text-richblack-50 transition-all duration-200 "><SiGmail /></a>
                ...
                {FooterLink2.map((element,index)=>{
                  return (
                    <div key={index} className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
                      ...
                      <div className="flex flex-col gap-2 mt-2">{element.links.map((link,index)=>{
                        return (
                          <div key={index} className="text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-200  ">
        ...
        {/* section 1 */}
          ...
          <div>
              <p className="flex items-center">Made with <LiaSmileSolid className="text-pink-500 text-lg m-1" /> Ashutosh. <FaRegCopyright className="m-1"/> 2025 Edunotion</p>
              <p className="flex text-sm items-center">
                All rights are reserved to Ashutosh Maurya.
              </p>
          </div>
          </div>
        </div>
